...
public class ModeloTablaComprasNC extends DefaultTableModel {
   private static final long serialVersionUID = 1L;

   public ModeloTablaComprasNC(Object[][] data, Object[] columnNames, JTable tabla) {
   ...
   public void formato(JTable tabla, int par_decimal_cantidad, int par_decimal_importe) {
      ...
      new JFormattedTextField((AbstractFormatterFactory)(new DefaultFormatterFactory(formatoDecimalDescuento)));
