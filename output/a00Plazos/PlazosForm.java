...
public class PlazosForm extends JinternalPadre {
   ...
   public void buscar() {
      if (!this.txt_codigo.getText().trim().equals("0") && Integer.parseInt(this.txt_codigo.getText()) != this.SW) {
         PlazosE b = PlazosE.buscarPlazo(Integer.parseInt(this.txt_codigo.getText().trim()), this);
         if (b == null) {
   ...
   public void guardar() {
      ...
      if (d.isResultadoEncontrado()) {
         PlazosE entidad = this.CargarEntidades();
         if (this.SW == 0) {
            if (entidad != null) {
               int codigo = PlazosE.insertarPlazos(entidad, this);
               if (codigo != 0) {
            ...
            int codigo = PlazosE.actualizarPlazos(entidad, this);
            if (codigo != 0) {
   ...
   public void eliminar() {
      if (Integer.parseInt(this.txt_codigo.getText()) == this.SW && this.SW != 0) {
         ...
         d.setVisible(true);
         if (d.isResultadoEncontrado()) {
            PlazosE ent = this.CargarEntidades();
            if (ent != null) {
               int codigo = PlazosE.eliminarPlazos(ent, this);
               if (codigo != 0) {
   ...
   public void cargarPlazos(PlazosE e) {
      this.txt_codigo.setValue(e.getCod_plazo());
      this.SW = Integer.parseInt(String.valueOf(e.getCod_plazo()));
      this.txt_nombre.setValue(e.getNombre_plazo());
   ...
   public PlazosE CargarEntidades() {
      int estado = 0;
      ...
      try {
         return new PlazosE(Integer.parseInt(this.txt_codigo.getText()), this.txt_nombre.getText(), estado, Integer.parseInt(this.txt_dias.getText()));
   ...
   public void buscarTabla() {
      ...
      if (filaSeleccionada != -1) {
         ...
         this.txt_dias.setText(this.tabla.getValueAt(filaSeleccionada, this.tabla.getColumn("Dias").getModelIndex()).toString());
   ...
   public PlazosForm() {
      this.setTitle("Registro de Plazos");
      this.setBounds(100, 100, 392, 393);
      PanelPadre panel_datos = new PanelPadre("");
      PanelPadre panel_plazos = new PanelPadre("Buscador de Registro");
      ...
      String[] cabecera = new String[]{"Codigo", "Nombre", "Estado", "Dias"};
      this.modeloTabla = new ModeloTablaDefecto(cabecera);
      this.tabla = new BuscadorTabla(this.modeloTabla, "Plazos", this);
               ...
               groupLayout.createSequentialGroup()
                  ...
                  .addGroup(
                     groupLayout.createParallelGroup(Alignment.TRAILING, false)
                        .addComponent(panel_plazos, Alignment.LEADING, 0, 0, 32767)
                        .addComponent(panel_datos, Alignment.LEADING, -2, 364, 32767)
                        .addGroup(
                           Alignment.LEADING,
                           groupLayout.createSequentialGroup()
                              .addComponent(lblLineasRecuperadas, -2, 127, -2)
                              .addGap(6)
      ...
      groupLayout.setVerticalGroup(
         groupLayout.createParallelGroup(Alignment.LEADING)
            .addGroup(
               groupLayout.createSequentialGroup()
                  .addContainerGap()
                  .addComponent(panel_datos, -2, 136, -2)
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addComponent(panel_plazos, -1, 190, 32767)
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addGroup(
                     groupLayout.createParallelGroup(Alignment.LEADING)
      ...
      GroupLayout gl_panel_plazos = new GroupLayout(panel_plazos);
      gl_panel_plazos.setHorizontalGroup(
         gl_panel_plazos.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_panel_plazos.createSequentialGroup()
                  .addGroup(
                     gl_panel_plazos.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_panel_plazos.createSequentialGroup().addGap(65).addComponent(this.txt_buscador, -2, 255, -2))
                        .addGroup(gl_panel_plazos.createSequentialGroup().addContainerGap().addComponent(scrollPane, -1, 340, 32767))
                  )
                  .addGap(14)
            )
      );
      gl_panel_plazos.setVerticalGroup(
         gl_panel_plazos.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_panel_plazos.createSequentialGroup()
                  .addComponent(this.txt_buscador, -2, 25, -2)
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addComponent(scrollPane, -1, 135, 32767)
                  .addContainerGap()
            )
      );
      panel_plazos.setLayout(gl_panel_plazos);
               ...
               gl_panel_datos.createSequentialGroup()
                  ...
                  .addGroup(
                     gl_panel_datos.createParallelGroup(Alignment.LEADING, false)
                        ...
                        .addComponent(lblNombre, -1, 56, 32767)
                  )
                  .addPreferredGap(ComponentPlacement.RELATED, 71, 32767)
                  .addGroup(
                     gl_panel_datos.createParallelGroup(Alignment.LEADING)
                        .addGroup(
                           gl_panel_datos.createSequentialGroup()
                        ...
                        .addComponent(this.txt_dias, -2, 73, -2)
                        .addComponent(this.txt_nombre, -2, 273, -2)
                  )
                  .addGap(55)
            )
      );
         ...
         gl_panel_datos.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_panel_datos.createSequentialGroup()
                  ...
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addGroup(
                     gl_panel_datos.createParallelGroup(Alignment.TRAILING).addComponent(lblNombre, -2, 25, -2).addComponent(this.txt_nombre, -2, 25, -2)
                  )
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addGroup(gl_panel_datos.createParallelGroup(Alignment.BASELINE).addComponent(this.txt_dias, -2, 25, -2).addComponent(lblDias, -2, 25, -2))
                  .addContainerGap(69, 32767)
            )
      );
      panel_datos.setLayout(gl_panel_datos);
      this.getContentPane().setLayout(groupLayout);
      new BuscadorTablaCargar(this.txt_buscador, this.lblLineasRecuperadasTexto, this.modeloTabla, "Plazos", this);
      this.inicializarObjetos();
      ...
      modeloSeleccion.addListSelectionListener(new ListSelectionListener() {
         ...
         public void valueChanged(ListSelectionEvent e) {
            if (!e.getValueIsAdjusting()) {
               int filaSeleccionada = PlazosForm.this.tabla.getSelectedRow();
               if (filaSeleccionada != -1) {
                  PlazosForm.this.buscarTabla();
               }
            }
         }
      });
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            PlazosForm frame = new PlazosForm();
