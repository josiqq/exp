...
public class ListadoComprasDevolucionForm extends JInternalPadreReporteJasper {
   ...
   private LimiteTextFieldConSQLJasper txt_cod_sucursal;
   ...
   public ListadoComprasDevolucionForm() {
      this.setTitle("Reporte de Listado de Devoluciones a Proveedores");
      ...
      LabelPrincipal lblCodigoSucursal = new LabelPrincipal("Sucursal", "label");
      ...
      this.txt_cod_sucursal = new LimiteTextFieldConSQLJasper(999999, this.lblNombreSucursal, "Depositos", this);
         ...
         gl_panel_filtro.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_panel_filtro.createSequentialGroup()
                  ...
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addComponent(lblCodigoSucursal, -2, 60, -2)
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addComponent(this.txt_cod_sucursal, -2, 41, -2)
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addComponent(this.lblNombreSucursal, -2, 289, -2)
                  .addGap(44)
            )
      );
                     ...
                     gl_panel_filtro.createParallelGroup(Alignment.LEADING)
                        ...
                        .addGroup(
                           gl_panel_filtro.createParallelGroup(Alignment.BASELINE)
                              .addComponent(lblCodigoSucursal, -2, 25, -2)
   ...
   public void exportarExcel() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final ListadoComprasDevolucionForm.DialogoProgreso dialogo = new ListadoComprasDevolucionForm.DialogoProgreso(null, "Exportando a Excel...");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JRXlsxExporter exporter = new JRXlsxExporter();
                     exporter.setExporterInput(new SimpleExporterInput(ListadoComprasDevolucionForm.this.jasperPrint));
                     ...
                     rs.setLocationRelativeTo(ListadoComprasDevolucionForm.this);
                     rs.setVisible(true);
   ...
   public void exportarPDF() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final ListadoComprasDevolucionForm.DialogoProgreso dialogo = new ListadoComprasDevolucionForm.DialogoProgreso(null, "Exportando a PDF");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JasperExportManager.exportReportToPdfFile(ListadoComprasDevolucionForm.this.jasperPrint, archivoDestino.getAbsolutePath());
                  } catch (Exception var3) {
   ...
   public void imprimirPDF() {
      ...
      if (this.jasperPrint == null) {
         ...
         final ListadoComprasDevolucionForm.DialogoProgreso dialogo = new ListadoComprasDevolucionForm.DialogoProgreso(null, "Imprimiendo Reporte...");
         SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            protected Void doInBackground() {
               try {
   ...
   public void recuperar() {
      final ListadoComprasDevolucionForm.DialogoProgreso dialogo = new ListadoComprasDevolucionForm.DialogoProgreso(null, "Generando Reporte...");
      SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
         protected Void doInBackground() {
            try {
               SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
               String fecha_ini = dateFormat.format(ListadoComprasDevolucionForm.this.txt_fecha_ini.getDate());
               String fecha_fin = dateFormat.format(ListadoComprasDevolucionForm.this.txt_fecha_final.getDate());
               Map<String, Object> parametros = new HashMap<>();
               parametros.put("par_nro_registro", 0);
               parametros.put("par_cod_sucursal", Integer.parseInt(ListadoComprasDevolucionForm.this.txt_cod_sucursal.getText().trim().replace(".", "")));
               parametros.put("par_cod_proveedor", Integer.parseInt(ListadoComprasDevolucionForm.this.txt_cod_proveedor.getText().trim().replace(".", "")));
               parametros.put("par_fecha_ini", fecha_ini);
               parametros.put("par_fecha_fin", fecha_fin);
               ListadoComprasDevolucionForm.this.generarReporte(
                  ListadoComprasDevolucionForm.this.panelPaginas, "reportes/ComprasDevolucion.jasper", "", parametros, "listado_compras"
               );
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            ListadoComprasDevolucionForm frame = new ListadoComprasDevolucionForm();
