...
public class ListadoComprasForm extends JInternalPadreReporteJasper {
   ...
   public void exportarExcel() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final ListadoComprasForm.DialogoProgreso dialogo = new ListadoComprasForm.DialogoProgreso(null, "Exportando a Excel...");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JRXlsxExporter exporter = new JRXlsxExporter();
                     exporter.setExporterInput(new SimpleExporterInput(ListadoComprasForm.this.jasperPrint));
                     ...
                     rs.setLocationRelativeTo(ListadoComprasForm.this);
                     rs.setVisible(true);
   ...
   public void exportarPDF() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final ListadoComprasForm.DialogoProgreso dialogo = new ListadoComprasForm.DialogoProgreso(null, "Exportando a PDF");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JasperExportManager.exportReportToPdfFile(ListadoComprasForm.this.jasperPrint, archivoDestino.getAbsolutePath());
                  } catch (Exception var3) {
   ...
   public void imprimirPDF() {
      ...
      if (this.jasperPrint == null) {
         ...
         final ListadoComprasForm.DialogoProgreso dialogo = new ListadoComprasForm.DialogoProgreso(null, "Imprimiendo Reporte...");
         SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            protected Void doInBackground() {
               try {
   ...
   public void recuperar() {
      final ListadoComprasForm.DialogoProgreso dialogo = new ListadoComprasForm.DialogoProgreso(null, "Generando Reporte...");
      SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
         protected Void doInBackground() {
            try {
               SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
               String fecha_ini = dateFormat.format(ListadoComprasForm.this.txt_fecha_ini.getDate());
               String fecha_fin = dateFormat.format(ListadoComprasForm.this.txt_fecha_final.getDate());
               Map<String, Object> parametros = new HashMap<>();
               parametros.put("par_nro_registro", 0);
               parametros.put("par_cod_sucursal", Integer.parseInt(ListadoComprasForm.this.txt_cod_sucursal.getText().trim().replace(".", "")));
               parametros.put("par_cod_proveedor", Integer.parseInt(ListadoComprasForm.this.txt_cod_proveedor.getText().trim().replace(".", "")));
               parametros.put("par_fecha_ini", fecha_ini);
               parametros.put("par_fecha_fin", fecha_fin);
               ListadoComprasForm.this.generarReporte(
                  ListadoComprasForm.this.panelPaginas, "reportes/Compras.jasper", "reportes/Compras_detalle.jasper", parametros, "listado_compras"
               );
