...
public class ListadoPedidosCompraForm extends JInternalPadreReporteJasper {
   ...
   public ListadoPedidosCompraForm() {
      this.setTitle("Reporte de Listado de Pedidos a Proveedores");
   ...
   public void exportarExcel() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final ListadoPedidosCompraForm.DialogoProgreso dialogo = new ListadoPedidosCompraForm.DialogoProgreso(null, "Exportando a Excel...");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JRXlsxExporter exporter = new JRXlsxExporter();
                     exporter.setExporterInput(new SimpleExporterInput(ListadoPedidosCompraForm.this.jasperPrint));
                     ...
                     rs.setLocationRelativeTo(ListadoPedidosCompraForm.this);
                     rs.setVisible(true);
   ...
   public void exportarPDF() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final ListadoPedidosCompraForm.DialogoProgreso dialogo = new ListadoPedidosCompraForm.DialogoProgreso(null, "Exportando a PDF");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JasperExportManager.exportReportToPdfFile(ListadoPedidosCompraForm.this.jasperPrint, archivoDestino.getAbsolutePath());
                  } catch (Exception var3) {
   ...
   public void imprimirPDF() {
      ...
      if (this.jasperPrint == null) {
         ...
         final ListadoPedidosCompraForm.DialogoProgreso dialogo = new ListadoPedidosCompraForm.DialogoProgreso(null, "Imprimiendo Reporte...");
         SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            protected Void doInBackground() {
               try {
   ...
   public void recuperar() {
      final ListadoPedidosCompraForm.DialogoProgreso dialogo = new ListadoPedidosCompraForm.DialogoProgreso(null, "Generando Reporte...");
      SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
         protected Void doInBackground() {
            try {
               SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
               String fecha_ini = dateFormat.format(ListadoPedidosCompraForm.this.txt_fecha_ini.getDate());
               String fecha_fin = dateFormat.format(ListadoPedidosCompraForm.this.txt_fecha_final.getDate());
               Map<String, Object> parametros = new HashMap<>();
               parametros.put("par_nro_registro", 0);
               parametros.put("par_cod_sucursal", Integer.parseInt(ListadoPedidosCompraForm.this.txt_cod_sucursal.getText().trim().replace(".", "")));
               parametros.put("par_cod_proveedor", Integer.parseInt(ListadoPedidosCompraForm.this.txt_cod_proveedor.getText().trim().replace(".", "")));
               parametros.put("par_fecha_ini", fecha_ini);
               parametros.put("par_fecha_fin", fecha_fin);
               ListadoPedidosCompraForm.this.generarReporte(
                  ListadoPedidosCompraForm.this.panelPaginas, "reportes/ComprasPedidos.jasper", "", parametros, "listado_pedidosProv"
               );
