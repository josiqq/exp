...
public class ListadoComprasNCForm extends JInternalPadreReporteJasper {
   ...
   public void exportarExcel() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final ListadoComprasNCForm.DialogoProgreso dialogo = new ListadoComprasNCForm.DialogoProgreso(null, "Exportando a Excel...");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JRXlsxExporter exporter = new JRXlsxExporter();
                     exporter.setExporterInput(new SimpleExporterInput(ListadoComprasNCForm.this.jasperPrint));
                     ...
                     rs.setLocationRelativeTo(ListadoComprasNCForm.this);
                     rs.setVisible(true);
   ...
   public void exportarPDF() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final ListadoComprasNCForm.DialogoProgreso dialogo = new ListadoComprasNCForm.DialogoProgreso(null, "Exportando a PDF");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JasperExportManager.exportReportToPdfFile(ListadoComprasNCForm.this.jasperPrint, archivoDestino.getAbsolutePath());
                  } catch (Exception var3) {
   ...
   public void imprimirPDF() {
      ...
      if (this.jasperPrint == null) {
         ...
         final ListadoComprasNCForm.DialogoProgreso dialogo = new ListadoComprasNCForm.DialogoProgreso(null, "Imprimiendo Reporte...");
         SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            protected Void doInBackground() {
               try {
   ...
   public void recuperar() {
      final ListadoComprasNCForm.DialogoProgreso dialogo = new ListadoComprasNCForm.DialogoProgreso(null, "Generando Reporte...");
      SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
         protected Void doInBackground() {
            try {
               SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
               String fecha_ini = dateFormat.format(ListadoComprasNCForm.this.txt_fecha_ini.getDate());
               String fecha_fin = dateFormat.format(ListadoComprasNCForm.this.txt_fecha_final.getDate());
               Map<String, Object> parametros = new HashMap<>();
               parametros.put("par_nro_registro", 0);
               parametros.put("par_cod_sucursal", Integer.parseInt(ListadoComprasNCForm.this.txt_cod_sucursal.getText().trim().replace(".", "")));
               parametros.put("par_cod_proveedor", Integer.parseInt(ListadoComprasNCForm.this.txt_cod_proveedor.getText().trim().replace(".", "")));
               parametros.put("par_fecha_ini", fecha_ini);
               parametros.put("par_fecha_fin", fecha_fin);
               ListadoComprasNCForm.this.generarReporte(
                  ListadoComprasNCForm.this.panelPaginas, "reportes/Compras.jasper", "reportes/Compras_detalle.jasper", parametros, "listado_compras"
               );
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            ListadoComprasNCForm frame = new ListadoComprasNCForm();
