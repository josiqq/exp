...
public class ReporteComprasProductoForm extends JinternalPadreReporte {
   ...
   public ReporteComprasProductoForm() {
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            ReporteComprasProductoForm frame = new ReporteComprasProductoForm();
