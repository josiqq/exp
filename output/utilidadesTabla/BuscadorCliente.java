...
public class BuscadorCliente extends JDialogBuscadores {
   ...
   public BuscadorCliente(JinternalPadre frame, int tipo) {
      ...
      String[] cabecera = new String[]{"Codigo", "Nombre", "RUC", "TipoFiscal"};
      this.modelo = new ModeloTablaDefecto(cabecera);
      this.tabla = new TablaBuscador(this.modelo, "CodigoNom4Cliente");
      ...
      this.btnSalir.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            BuscadorCliente.this.dispose();
         }
      });
      this.btnSeleccionar.addActionListener(new ActionListener() {
         @Override
         public void actionPerformed(ActionEvent e) {
            int filaSeleccionada = BuscadorCliente.this.tabla.getSelectedRow();
            if (filaSeleccionada != -1) {
               BuscadorCliente.this.seleccionLinea(filaSeleccionada, 1);
            }
         }
      });
      this.txt_buscador.addKeyListener(new KeyListener() {
         ...
         public void keyPressed(KeyEvent e) {
            if (e.getKeyCode() == 10) {
               BuscadorCliente.this.cargarTabla(1);
            }
         }
      });
      this.tabla.addKeyListener(new KeyListener() {
         ...
         public void keyPressed(KeyEvent e) {
            if (e.getKeyCode() == 10) {
               int filaSeleccionada = BuscadorCliente.this.tabla.getSelectedRow();
               BuscadorCliente.this.seleccionLinea(filaSeleccionada);
            }
         }
      });
   }
   ...
   private void cargarTabla(int tipo) {
      ...
      if (this.txt_buscador.getText().equals("")) {
         sql = "select cod_cliente,nombre_cliente,ruc,tipo_fiscal from clientes where estado =1";
      } else {
         sql = "select cod_cliente,nombre_cliente,ruc,tipo_fiscal from clientes where estado =1 and nombre_cliente like '%"
            + this.txt_buscador.getText()
            + "%'";
      }

      ClientesE.cargarClientesTabla4(sql, this.modelo, this.frame);
   ...
   private void seleccionLinea(int filaSeleccionada, int tipo) {
      ...
      this.tipo_fiscal = Integer.parseInt(this.tabla.getValueAt(filaSeleccionada, this.tabla.getColumn("TipoFiscal").getModelIndex()).toString());
      this.seleccionado = true;
      this.dispose();
   }

   public BuscadorCliente(JinternalPadre frame) {
      PanelPadre contentPanel = new PanelPadre("");
      PanelPadre panel = new PanelPadre("");
      this.frame = frame;
      this.setTitle("Buscador de Clientes");
      ...
      this.btnSeleccionar = new BotonPadre("Seleccionar", "acceder.png");
      this.btnSalir = new BotonPadre("Salir", "salir.png");
      String[] cabecera = new String[]{"Codigo", "Nombre", "RUC"};
      this.modelo = new ModeloTablaDefecto(cabecera);
      this.tabla = new TablaBuscador(this.modelo, "CodigoNom3Cliente");
      this.tabla.setName("tabla_buscador");
      TablaScrollPane scrollPane = new TablaScrollPane(this.tabla);
      GroupLayout gl_contentPanel = new GroupLayout(contentPanel);
      gl_contentPanel.setHorizontalGroup(
      ...
      this.txt_buscador.addKeyListener(new KeyListener() {
         ...
         public void keyPressed(KeyEvent e) {
            if (e.getKeyCode() == 10) {
               BuscadorCliente.this.cargarTabla();
            }
         }
      });
      this.tabla.addKeyListener(new KeyListener() {
   ...
   private void cargarTabla() {
      ...
      String sql = "";
      if (this.txt_buscador.getText().equals("")) {
         sql = "select cod_cliente,nombre_cliente,ruc from clientes where estado =1";
      } else {
         sql = "select cod_cliente,nombre_cliente,ruc from clientes where estado =1 and nombre_cliente like '%" + this.txt_buscador.getText() + "%'";
      }
   ...
   public static void main(String[] args) {
      BuscadorCliente dialog = new BuscadorCliente(null, 0);
