...
public class ExcelExporterAbrirExcel {
      ...
      while (true) {
         ...
         SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            protected Void doInBackground() {
               ExcelExporterAbrirExcel.this.exportarJTableAXLS(table, finalFilePath);
               return null;
            }
            ...
            protected void done() {
               ...
               ExcelExporterAbrirExcel.this.abrirArchivoExcel(finalFilePath);
            }
         };
         worker.execute();
   ...
   private void abrirArchivoExcel(String filePath) {
      try {
