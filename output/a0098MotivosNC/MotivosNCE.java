...
public class MotivosNCE {
   private int cod_motivo;
   private int estado;
   private int tipo;
   private String nombre_motivo;

   public static int eliminarMotivosNC(MotivosNCE entidad, JinternalPadre frame) {
      ...
      try {
         ...
         psEliminarMotivo = conexion.prepareStatement("delete from motivos_nc where cod_motivo =?");
   ...
   public static int actualizarMotivoNC(MotivosNCE entidad, JinternalPadre frame) {
      ...
      try {
         DatabaseConnection db = DatabaseConnection.getInstance();
         conexion = db.abrirConexion();
         psActualizarMotivo = conexion.prepareStatement("update motivos set nombre_motivo=?,estado=?,tipo=? where cod_motivo =?");
         psActualizarMotivo.setString(1, entidad.getNombre_motivo());
         psActualizarMotivo.setInt(2, entidad.getEstado());
         psActualizarMotivo.setInt(3, entidad.getTipo());
         psActualizarMotivo.setInt(4, entidad.getCod_motivo());
   ...
   public static int insertarMotivoNC(MotivosNCE entidad, JinternalPadre frame) {
      ...
      try {
         DatabaseConnection db = DatabaseConnection.getInstance();
         conexion = db.abrirConexion();
         preparedStatementRegistromayor = conexion.prepareStatement("Select max(cod_motivo) as mayor from motivos_nc");
         ...
         psInsertarMotivo = conexion.prepareStatement("insert into motivos_nc (cod_motivo,nombre_motivo,estado,tipo) values(?,?,?,?)");
         ...
         psInsertarMotivo.setInt(4, entidad.getTipo());
   ...
   public static void cargarMotivosNCTabla(String sql, ModeloTablaDefecto modelo, JDialog frame) {
   ...
   public static MotivosNCE buscarMotivoNC(int codigo, JinternalPadre frame) {
      PreparedStatement preparedStatementSelect = null;
      ResultSet resultado = null;
      Connection conexion = null;
      ...
      try {
         DatabaseConnection db = DatabaseConnection.getInstance();
         conexion = db.abrirConexion();
         preparedStatementSelect = conexion.prepareStatement("Select cod_motivo,nombre_motivo,estado,tipo from motivos_nc where cod_motivo =?");
         preparedStatementSelect.setInt(1, codigo);
         resultado = preparedStatementSelect.executeQuery();
         if (resultado.next()) {
            return new MotivosNCE(resultado.getInt("cod_motivo"), resultado.getString("nombre_motivo"), resultado.getInt("estado"), resultado.getInt("tipo"));
         }
   ...
   public static MotivosNCE buscarMotivoNC2(int codigo, JinternalPadre frame) {
      PreparedStatement preparedStatementSelect = null;
      ResultSet resultado = null;
      Connection conexion = null;
      ...
      try {
         DatabaseConnection db = DatabaseConnection.getInstance();
         conexion = db.abrirConexion();
         preparedStatementSelect = conexion.prepareStatement("select cod_motivo,nombre_motivo from motivos_nc where cod_motivo =?");
         preparedStatementSelect.setInt(1, codigo);
         resultado = preparedStatementSelect.executeQuery();
         if (resultado.next()) {
            return new MotivosNCE(resultado.getInt("cod_motivo"), resultado.getString("nombre_motivo"));
         }
      } catch (Exception var11) {
         LogErrores.errores(var11, "Error al seleccionar Motivo..", frame);
         return null;
   ...
   public MotivosNCE(int cod_motivo, String nombre_motivo) {
      this.cod_motivo = cod_motivo;
      this.nombre_motivo = nombre_motivo;
   }

   public MotivosNCE(int cod_motivo, String nombre_motivo, int estado, int tipo) {
      this.cod_motivo = cod_motivo;
      this.nombre_motivo = nombre_motivo;
      this.estado = estado;
      this.tipo = tipo;
