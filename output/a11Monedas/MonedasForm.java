...
public class MonedasForm extends JinternalPadre {
   ...
   public void buscar() {
      if (!this.txt_codigo.getText().trim().equals("0") && Integer.parseInt(this.txt_codigo.getText()) != this.SW) {
         MonedasE b = MonedasE.buscarMoneda(Integer.parseInt(this.txt_codigo.getText().trim()), this);
         if (b == null) {
   ...
   public void guardar() {
      ...
      if (d.isResultadoEncontrado()) {
         MonedasE entidad = this.CargarEntidades();
         if (this.SW == 0) {
            if (entidad != null) {
               int codigo = MonedasE.insertarMonedas(entidad, this);
               if (codigo != 0) {
            ...
            int codigo = MonedasE.actualizarMonedas(entidad, this);
            if (codigo != 0) {
   ...
   public void eliminar() {
      if (Integer.parseInt(this.txt_codigo.getText()) == this.SW && this.SW != 0) {
         ...
         d.setVisible(true);
         if (d.isResultadoEncontrado()) {
            MonedasE ent = this.CargarEntidades();
            if (ent != null) {
               int codigo = MonedasE.eliminarMonedas(ent, this);
               if (codigo != 0) {
   ...
   public void cargarMonedas(MonedasE e) {
      this.txt_codigo.setValue(e.getCod_moneda());
      this.SW = Integer.parseInt(String.valueOf(e.getCod_moneda()));
      this.txt_nombre.setValue(e.getNombre_moneda());
   ...
   public MonedasE CargarEntidades() {
      int estado = 0;
      ...
      try {
         return new MonedasE(Integer.parseInt(this.txt_codigo.getText()), this.txt_nombre.getText(), estado, this.txt_sigla.getText());
   ...
   public MonedasForm() {
      this.setTitle("Registro de Monedas");
      this.setBounds(100, 100, 272, 362);
      ...
      this.tabla = new BuscadorTabla(this.modeloTabla, "Monedas", this);
                           ...
                           groupLayout.createSequentialGroup()
                              .addGroup(
                                 groupLayout.createParallelGroup(Alignment.TRAILING)
                                    ...
                                    .addComponent(panel_datos, Alignment.LEADING, -2, 255, -2)
                              )
      ...
      groupLayout.setVerticalGroup(
         groupLayout.createParallelGroup(Alignment.LEADING)
            .addGroup(
               groupLayout.createSequentialGroup()
                  .addContainerGap()
                  .addComponent(panel_datos, -2, 118, -2)
                  .addPreferredGap(ComponentPlacement.RELATED)
         ...
         gl_panel_buscador.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_panel_buscador.createSequentialGroup()
                  .addGroup(
                     gl_panel_buscador.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_panel_buscador.createSequentialGroup().addGap(54).addComponent(this.txt_buscador, -2, 173, -2))
                        .addComponent(this.scrollPane, -1, 254, 32767)
                  )
                  .addContainerGap()
            )
      );
         ...
         gl_panel_buscador.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_panel_buscador.createSequentialGroup()
                  ...
                  .addComponent(this.scrollPane, -1, 170, 32767)
                  .addContainerGap()
            )
      );
               ...
               gl_panel_datos.createSequentialGroup()
                  ...
                  .addGroup(
                     gl_panel_datos.createParallelGroup(Alignment.LEADING, false)
                        ...
                        .addComponent(this.txt_sigla, -2, 82, -2)
                  )
         ...
         gl_panel_datos.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_panel_datos.createSequentialGroup()
                  ...
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addGroup(gl_panel_datos.createParallelGroup(Alignment.BASELINE).addComponent(lblSigla, -2, 25, -2).addComponent(this.txt_sigla, -2, 25, -2))
                  .addContainerGap(46, 32767)
            )
      );
      panel_datos.setLayout(gl_panel_datos);
      this.getContentPane().setLayout(groupLayout);
      new BuscadorTablaCargar(this.txt_buscador, this.lblLineasRecuperadasTexto, this.modeloTabla, "Monedas", this);
      this.inicializarObjetos();
      ...
      modeloSeleccion.addListSelectionListener(new ListSelectionListener() {
         ...
         public void valueChanged(ListSelectionEvent e) {
            if (!e.getValueIsAdjusting()) {
               int filaSeleccionada = MonedasForm.this.tabla.getSelectedRow();
               if (filaSeleccionada != -1) {
                  MonedasForm.this.buscarTabla();
               }
            }
         }
      });
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            MonedasForm frame = new MonedasForm();
