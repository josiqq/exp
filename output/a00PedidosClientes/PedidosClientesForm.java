...
import a00Ventas.VentasParametrosE;
...
public class PedidosClientesForm extends JinternalPadre {
   ...
   protected TablaDetallePedidosCliente tabla;
   ...
   public void buscar() {
      if (!this.txt_codigo.getText().trim().equals("0") && Integer.parseInt(this.txt_codigo.getText()) != this.SW) {
         PedidosClientesE b = PedidosClientesE.buscarPedidoCliente(Integer.parseInt(this.txt_codigo.getText().trim()), this.tabla, this);
         if (b == null) {
   ...
   public void guardar() {
      ...
      if (d.isResultadoEncontrado()) {
         PedidosClientesE entidad = this.CargarEntidades();
         if (this.SW == 0) {
            if (entidad != null) {
               int codigo = PedidosClientesE.insertarPedidoCliente(entidad, this.tabla, this);
               if (codigo != 0) {
            ...
            int codigo = PedidosClientesE.actualizarPedidosClientes(entidad, this.tabla, this.codigosAEliminar, this);
            if (codigo != 0) {
   ...
   public void eliminar() {
      if (Integer.parseInt(this.txt_codigo.getText()) == this.SW && this.SW != 0) {
         ...
         d.setVisible(true);
         if (d.isResultadoEncontrado()) {
            PedidosClientesE ent = this.CargarEntidades();
            if (ent != null) {
               int codigo = PedidosClientesE.eliminarPedidoCliente(ent, this);
               if (codigo != 0) {
   ...
   public void cargarPedido(PedidosClientesE e) {
   ...
   public PedidosClientesE CargarEntidades() {
   ...
   private void inicializarObjetos() {
      ...
      ModeloPedidoCliente modelo = (ModeloPedidoCliente)this.tabla.getModel();
   ...
   public PedidosClientesForm() {
      this.setTitle("Registro de Pedidos a Clientes");
      ...
      this.txt_cod_tipo_documento = new LimiteTextFieldTipoDoc(999999, this.lblNombreTipoDocumentoTexto, null, null, this);
      ...
      this.tabla = new TablaDetallePedidosCliente(
      ...
      this.txt_porcentaje_descuento.addFocusListener(new FocusListener() {
         ...
         public void focusLost(FocusEvent e) {
            PedidosClientesForm.this.focoDescuentoCabeceraPorcentaje();
         }
         ...
         .put(
            ...
            new AbstractAction() {
               ...
               public void actionPerformed(ActionEvent e) {
                  if (PedidosClientesForm.this.tabla.getSelectedColumn() == 0) {
                     BuscadorProducto buscador = new BuscadorProducto();
                     buscador.setLocationRelativeTo(PedidosClientesForm.this);
                     buscador.setModal(true);
                     buscador.setVisible(true);
                     if (buscador.getCodigo() != null) {
                        int filaSeleccionada = PedidosClientesForm.this.tabla.getSelectedRow();
                        PedidosClientesForm.this.tabla.clearSelection();
                        PedidosClientesForm.this.tabla.requestFocusInWindow();
                        PedidosClientesForm.this.tabla
                           .changeSelection(filaSeleccionada, PedidosClientesForm.this.tabla.getColumn("Cantidad").getModelIndex(), false, false);
                        PedidosClientesForm.this.tabla.editCellAt(filaSeleccionada, PedidosClientesForm.this.tabla.getColumn("Cantidad").getModelIndex());
                        Component editorComponent = PedidosClientesForm.this.tabla.getEditorComponent();
                     ...
                     try {
                        fecha = dateFormat.format(PedidosClientesForm.this.txt_fecha.getDate());
                     } catch (Exception var10) {
                        LogErrores.errores(var10, "Debe de cargar Fecha de Venta...");
                     }

                     ProductosE producto = ProductosE.cargarProductosPedidosVta(
                        buscador.getCodigo(),
                        Integer.parseInt(String.valueOf(PedidosClientesForm.this.txt_cod_cliente.getText())),
                        Integer.parseInt(String.valueOf(PedidosClientesForm.this.txt_cod_moneda.getText())),
                        fecha,
                        PedidosClientesForm.this,
                        Integer.parseInt(String.valueOf(PedidosClientesForm.this.txt_cod_condicion.getValue()))
                     );
                     FormatoDecimalOperacionSistema formatoDecimalImporte = new FormatoDecimalOperacionSistema(7);
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           buscador.getCodigo(),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("Código").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           producto.getNombre_producto(),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("Descripción").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           producto.getTipo_fiscal(),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("TF").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           producto.getIva_producto(),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("IVA").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           producto.getPorcentaje_gravado(),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("Gravado").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           producto.getPorc_regimen(),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("REG").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           producto.getNombreUnidadMedida(),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("UM").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           formatoDecimalImporte.format(producto.getCosto_producto()),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("Costo").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           producto.getCod_lista(),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("CodLista").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           formatoDecimalImporte.format(producto.getPrecio_lista()),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("Precio Lista").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           formatoDecimalImporte.format(producto.getPrecio()),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("Precio Bruto").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           formatoDecimalImporte.format(producto.getPrecio_minimo()),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("Precio Minimo").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(
                           formatoDecimalImporte.format(producto.getPrecio()),
                           PedidosClientesForm.this.tabla.getSelectedRow(),
                           PedidosClientesForm.this.tabla.getColumn("Precio Venta").getModelIndex()
                        );
                     PedidosClientesForm.this.tabla
                        .setValueAt(0, PedidosClientesForm.this.tabla.getSelectedRow(), PedidosClientesForm.this.tabla.getColumn("Desc.").getModelIndex());
                     F_Calcular_Vtas.calcularDescuento(PedidosClientesForm.this.tabla.getSelectedRow(), PedidosClientesForm.this.tabla);
                     CalculosTabla.calcularIvas(
                        PedidosClientesForm.this.tabla.getSelectedRow(),
                        PedidosClientesForm.this.tabla,
                        Integer.parseInt(PedidosClientesForm.this.txt_tipo_fiscal_cliente.getText())
                     );
                     CalculosTabla.cargarImpuestos(
                        PedidosClientesForm.this.tabla,
                        PedidosClientesForm.this.txt_exentas,
                        PedidosClientesForm.this.txt_gravado10,
                        PedidosClientesForm.this.txt_iva10,
                        PedidosClientesForm.this.txt_gravado5,
                        PedidosClientesForm.this.txt_iva5,
                        PedidosClientesForm.this.txt_total_impuestos,
                        Integer.parseInt(PedidosClientesForm.this.txt_tipo_fiscal_cliente.getText())
                     );
                     Number valor = (Number)PedidosClientesForm.this.txt_total_impuestos.getValue();
                     double totalImpuesto = valor.doubleValue();
                     PedidosClientesForm.this.txt_total_moneda1
                        .setValue(
                           CotizacionesE.cambiarImporte(Integer.parseInt(PedidosClientesForm.this.txt_cod_moneda.getText()), 1, totalImpuesto, null)
                              .getCotizacion()
                        );
                     PedidosClientesForm.this.txt_total_moneda2
                        .setValue(
                           CotizacionesE.cambiarImporte(Integer.parseInt(PedidosClientesForm.this.txt_cod_moneda.getText()), 2, totalImpuesto, null)
                              .getCotizacion()
                        );
                     PedidosClientesForm.this.txt_total_moneda3
                        .setValue(
                           CotizacionesE.cambiarImporte(Integer.parseInt(PedidosClientesForm.this.txt_cod_moneda.getText()), 3, totalImpuesto, null)
                              .getCotizacion()
                        );
                     PedidosClientesForm.this.txt_total_moneda4
                        .setValue(
                           CotizacionesE.cambiarImporte(Integer.parseInt(PedidosClientesForm.this.txt_cod_moneda.getText()), 4, totalImpuesto, null)
                              .getCotizacion()
                        );
                  }
               }
      ...
      this.txt_cod_condicion
         .addFocusListener(
            new FocusListener() {
               @Override
               public void focusLost(FocusEvent e) {
                  if (VerificarCamposVacios.verificar(PedidosClientesForm.this.txt_cod_deposito, PedidosClientesForm.this)
                     && VerificarCamposVacios.verificar(PedidosClientesForm.this.txt_cod_moneda, PedidosClientesForm.this)
                     && VerificarCamposVacios.verificar(PedidosClientesForm.this.txt_cod_cliente, PedidosClientesForm.this)) {
                     PedidosClientesForm.this.deshabilitarCabecera();
                     ModeloPedidoCliente modelo = (ModeloPedidoCliente)PedidosClientesForm.this.tabla.getModel();
      ...
      this.addInternalFrameListener(new InternalFrameAdapter() {
         ...
         public void internalFrameClosed(InternalFrameEvent e) {
            ...
            StockDepositosE.eliminarTodoReserva(PedidosClientesForm.this.ID_PETICION);
         }
      });
   }
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            PedidosClientesForm frame = new PedidosClientesForm();
