...
public class CategoriaClienteForm extends JinternalPadre {
   ...
   public void buscar() {
      if (!this.txt_codigo.getText().trim().equals("0") && Integer.parseInt(this.txt_codigo.getText()) != this.SW) {
         CategoriaClienteE b = CategoriaClienteE.buscarCategoria(Integer.parseInt(this.txt_codigo.getText().trim()), this);
         if (b == null) {
   ...
   public void guardar() {
      ...
      if (d.isResultadoEncontrado()) {
         CategoriaClienteE entidad = this.CargarEntidades();
         if (this.SW == 0) {
            if (entidad != null) {
               int codigo = CategoriaClienteE.insertarCategoriaCliente(entidad, this);
               if (codigo != 0) {
            ...
            int codigo = CategoriaClienteE.actualizarCategoriaCliente(entidad, this);
            if (codigo != 0) {
   ...
   public void eliminar() {
      if (Integer.parseInt(this.txt_codigo.getText()) == this.SW && this.SW != 0) {
         ...
         d.setVisible(true);
         if (d.isResultadoEncontrado()) {
            CategoriaClienteE ent = this.CargarEntidades();
            if (ent != null) {
               int codigo = CategoriaClienteE.eliminarCategoriaCliente(ent, this);
               if (codigo != 0) {
   ...
   public void cargarCategorias(CategoriaClienteE e) {
      this.txt_codigo.setValue(e.getCod_categoria());
      this.SW = Integer.parseInt(String.valueOf(e.getCod_categoria()));
      this.txt_nombre.setValue(e.getNombre_categoria());
      if (e.getEstado() == 1) {
   ...
   public CategoriaClienteE CargarEntidades() {
      int estado = 0;
      ...
      try {
         return new CategoriaClienteE(Integer.parseInt(this.txt_codigo.getText()), this.txt_nombre.getText(), estado);
   ...
   public CategoriaClienteForm() {
      this.setTitle("Registro de Categoria de Clientes");
      this.setBounds(100, 100, 364, 400);
      ...
      this.tabla = new BuscadorTabla(this.modeloTabla, "ClientesCategoria", this);
                     ...
                     groupLayout.createParallelGroup(Alignment.LEADING)
                        .addGroup(
                           groupLayout.createParallelGroup(Alignment.TRAILING, false)
                              ...
                              .addComponent(panel_datos, Alignment.LEADING, -1, 346, 32767)
                        )
                        .addGroup(
                           groupLayout.createSequentialGroup()
      ...
      groupLayout.setVerticalGroup(
         groupLayout.createParallelGroup(Alignment.LEADING)
            .addGroup(
               groupLayout.createSequentialGroup()
                  .addContainerGap()
                  .addComponent(panel_datos, -2, 98, -2)
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addComponent(panel_buscador, -2, 233, -2)
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addGroup(
         ...
         gl_panel_buscador.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_panel_buscador.createSequentialGroup()
                  .addGroup(
                     gl_panel_buscador.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_panel_buscador.createSequentialGroup().addGap(52).addComponent(this.txt_buscador, -2, 264, -2))
                        .addGroup(gl_panel_buscador.createSequentialGroup().addContainerGap().addComponent(scrollPane, -1, 323, 32767))
                  )
                  .addContainerGap()
            )
      );
         ...
         gl_panel_buscador.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_panel_buscador.createSequentialGroup()
                  ...
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addComponent(scrollPane, -1, 199, 32767)
            )
      );
               ...
               gl_panel_datos.createSequentialGroup()
                  ...
                  .addGroup(
                     gl_panel_datos.createParallelGroup(Alignment.LEADING)
                        ...
                        .addComponent(this.txt_nombre, -2, 270, -2)
                  )
      ...
      new BuscadorTablaCargar(this.txt_buscador, this.lblLineasRecuperadasTexto, this.modeloTabla, "ClientesCategoria", this);
      this.inicializarObjetos();
      ...
      modeloSeleccion.addListSelectionListener(new ListSelectionListener() {
         ...
         public void valueChanged(ListSelectionEvent e) {
            if (!e.getValueIsAdjusting()) {
               int filaSeleccionada = CategoriaClienteForm.this.tabla.getSelectedRow();
               if (filaSeleccionada != -1) {
                  CategoriaClienteForm.this.buscarTabla();
               }
            }
         }
      });
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            CategoriaClienteForm frame = new CategoriaClienteForm();
