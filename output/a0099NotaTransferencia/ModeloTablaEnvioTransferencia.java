...
public class ModeloTablaEnvioTransferencia extends DefaultTableModel {
   private static final long serialVersionUID = 1L;

   public ModeloTablaEnvioTransferencia(Object[][] data, Object[] columnNames) {
   ...
   public void formato(JTable tabla, int par_decimal_cantidad, int par_decimal_importe) {
      ...
      tabla.getColumn("Tipo Fiscal").setResizable(false);
      tabla.getColumn("Tipo Fiscal").setMinWidth(0);
      tabla.getColumn("Tipo Fiscal").setMaxWidth(0);
      tabla.getColumn("IVA").setResizable(false);
      tabla.getColumn("IVA").setMinWidth(0);
      tabla.getColumn("IVA").setMaxWidth(0);
      tabla.getColumn("PorcGravado").setResizable(false);
      tabla.getColumn("PorcGravado").setMinWidth(0);
      tabla.getColumn("PorcGravado").setMaxWidth(0);
      ...
      tabla.getColumn("Cantidad").setCellEditor(new DefaultCellEditor(cantidadField));
   }

   public void addDefaultRow() {
      this.addRow(new Object[]{"", "", "", 0, 0, 0, 0, 0, 0, 0});
   }
