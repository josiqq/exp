...
public class ListadoPedidosVtaForm extends JInternalPadreReporteJasper {
   ...
   public ListadoPedidosVtaForm() {
      this.setTitle("Reporte de Listado de Pedidos de Clientes");
   ...
   public void exportarExcel() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final ListadoPedidosVtaForm.DialogoProgreso dialogo = new ListadoPedidosVtaForm.DialogoProgreso(null, "Exportando a Excel...");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JRXlsxExporter exporter = new JRXlsxExporter();
                     exporter.setExporterInput(new SimpleExporterInput(ListadoPedidosVtaForm.this.jasperPrint));
                     ...
                     rs.setLocationRelativeTo(ListadoPedidosVtaForm.this);
                     rs.setVisible(true);
   ...
   public void exportarPDF() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final ListadoPedidosVtaForm.DialogoProgreso dialogo = new ListadoPedidosVtaForm.DialogoProgreso(null, "Exportando a PDF");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JasperExportManager.exportReportToPdfFile(ListadoPedidosVtaForm.this.jasperPrint, archivoDestino.getAbsolutePath());
                  } catch (Exception var3) {
   ...
   public void imprimirPDF() {
      ...
      if (this.jasperPrint == null) {
         ...
         final ListadoPedidosVtaForm.DialogoProgreso dialogo = new ListadoPedidosVtaForm.DialogoProgreso(null, "Imprimiendo Reporte...");
         SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            protected Void doInBackground() {
               try {
   ...
   public void recuperar() {
      final ListadoPedidosVtaForm.DialogoProgreso dialogo = new ListadoPedidosVtaForm.DialogoProgreso(null, "Generando Reporte...");
      SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
         protected Void doInBackground() {
            try {
               SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
               String fecha_ini = dateFormat.format(ListadoPedidosVtaForm.this.txt_fecha_ini.getDate());
               String fecha_fin = dateFormat.format(ListadoPedidosVtaForm.this.txt_fecha_final.getDate());
               Map<String, Object> parametros = new HashMap<>();
               parametros.put("par_nro_registro", 0);
               parametros.put("par_cod_deposito", Integer.parseInt(ListadoPedidosVtaForm.this.txt_cod_deposito.getText().trim().replace(".", "")));
               parametros.put("par_cod_cliente", Integer.parseInt(ListadoPedidosVtaForm.this.txt_cod_cliente.getText().trim().replace(".", "")));
               parametros.put("par_fecha_ini", fecha_ini);
               parametros.put("par_fecha_fin", fecha_fin);
               ListadoPedidosVtaForm.this.generarReporte(
                  ListadoPedidosVtaForm.this.panelPaginas, "reportes/VentasPedidos.jasper", "", parametros, "listado_pedidosVta"
               );
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            ListadoPedidosVtaForm frame = new ListadoPedidosVtaForm();
