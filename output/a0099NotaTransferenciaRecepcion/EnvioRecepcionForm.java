...
public class EnvioRecepcionForm extends JinternalPadre {
   private TablaDetalleEnvioRecepcion tabla;
   public int SW;
   ...
   public void buscar() {
      if (!this.txt_codigo.getText().trim().equals("0") && Integer.parseInt(this.txt_codigo.getText()) != this.SW) {
         EnvioRecepcionE b = EnvioRecepcionE.buscarRecepcionTransferencia(Integer.parseInt(this.txt_codigo.getText().trim()), this, this.tabla, 2, 2);
         if (b != null && b.getTransferencia() != 0) {
            this.cargarRecepcionTransferencia(b);
         } else {
   ...
   public void guardar() {
      ...
      if (d.isResultadoEncontrado()) {
         ...
         EnvioRecepcionE entidad = this.CargarEntidades();
         if (this.SW == Integer.parseInt(this.txt_codigo.getText())) {
            int codigo = EnvioRecepcionE.actualizarRecepcionTransferencia(Integer.parseInt(this.txt_codigo.getText()), this, this.tabla);
            if (codigo != 0) {
   ...
   public void eliminar() {
      if (Integer.parseInt(this.txt_codigo.getText()) == this.SW && this.SW != 0) {
         ...
         d.setVisible(true);
         if (d.isResultadoEncontrado()) {
            EnvioRecepcionE ent = this.CargarEntidades();
            if (ent != null) {
               int codigo = EnvioRecepcionE.eliminarRecepcionDeposito(ent, this);
               if (codigo != 0) {
   ...
   public void cargarRecepcionTransferencia(EnvioRecepcionE e) {
      if (e.getRecibido() == 1) {
   ...
   public EnvioRecepcionE CargarEntidades() {
      int recibido = 0;
      if (this.chckbxRecibido.isSelected()) {
         recibido = 1;
      }

      try {
         return new EnvioRecepcionE(Integer.parseInt(this.txt_codigo.getText().trim().replace(".", "")), recibido);
   ...
   private void inicializarObjetos() {
      FormatoDecimalOperacionSistema formatoLinea = new FormatoDecimalOperacionSistema(0);
      this.lblUltimoRegistroTexto.setText(String.valueOf(formatoLinea.format(EnvioRecepcionE.ultimoRegistro(this))));
      ...
      ModeloTablaEnvioRecepcion modelo = (ModeloTablaEnvioRecepcion)this.tabla.getModel();
   ...
   public EnvioRecepcionForm() {
      this.setTitle("Registro de Recepcion de Envio de Depositos");
      this.setBounds(100, 100, 934, 569);
      ...
      this.tabla = new TablaDetalleEnvioRecepcion(this.lblTotalLineasTexto, 2, 2);
         ...
         gl_contentPane.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_contentPane.createSequentialGroup()
                  ...
                  .addGroup(
                     gl_contentPane.createParallelGroup(Alignment.LEADING)
                        .addComponent(panel_detalle, -2, 914, -2)
                        .addComponent(panel_cabecera, -2, 914, -2)
                        .addGroup(
                           gl_contentPane.createSequentialGroup()
         ...
         gl_contentPane.createParallelGroup(Alignment.LEADING)
            .addGroup(
               gl_contentPane.createSequentialGroup()
                  ...
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addComponent(panel_detalle, -2, 331, -2)
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addGroup(
               ...
               gl_panel_cabecera.createSequentialGroup()
                  ...
                  .addGroup(
                     gl_panel_cabecera.createParallelGroup(Alignment.LEADING, false)
                        ...
                        .addGroup(
                           gl_panel_cabecera.createSequentialGroup()
                              .addComponent(lblObservacion, -2, 108, -2)
                     ...
                     gl_panel_cabecera.createParallelGroup(Alignment.LEADING)
                        .addGroup(
                           gl_panel_cabecera.createSequentialGroup()
                              ...
                              .addGroup(
                                 gl_panel_cabecera.createParallelGroup(Alignment.LEADING, false)
                                    .addComponent(lblDepositoDestino, -1, 108, 32767)
                                    .addComponent(lblHoraEnvio, -1, -1, 32767)
                        ...
                        .addGroup(gl_panel_cabecera.createSequentialGroup().addGap(18).addComponent(this.txt_observacion, -2, 713, -2))
                  )
               ...
               gl_panel_cabecera.createSequentialGroup()
                  ...
                  .addGroup(
                     gl_panel_cabecera.createParallelGroup(Alignment.LEADING)
                        ...
                        .addComponent(this.txt_observacion, -2, 40, -2)
                  )
                  .addGap(74)
            )
      );
         ...
         .put(
            ...
            new AbstractAction() {
               ...
               public void actionPerformed(ActionEvent e) {
                  if (EnvioRecepcionForm.this.tabla.getSelectedColumn() == 0) {
                     BuscadorProducto buscador = new BuscadorProducto();
                     buscador.setLocationRelativeTo(EnvioRecepcionForm.this);
                     buscador.setModal(true);
                     buscador.setVisible(true);
                     if (buscador.getCodigo() != null) {
                        int filaSeleccionada = EnvioRecepcionForm.this.tabla.getSelectedRow();
                        EnvioRecepcionForm.this.tabla.clearSelection();
                        EnvioRecepcionForm.this.tabla.requestFocusInWindow();
                        EnvioRecepcionForm.this.tabla
                           .changeSelection(filaSeleccionada, EnvioRecepcionForm.this.tabla.getColumn("Cantidad").getModelIndex(), false, false);
                        EnvioRecepcionForm.this.tabla.editCellAt(filaSeleccionada, EnvioRecepcionForm.this.tabla.getColumn("Cantidad").getModelIndex());
                        Component editorComponent = EnvioRecepcionForm.this.tabla.getEditorComponent();
                        ...
                        EnvioRecepcionForm.this.tabla
                           .setValueAt(
                              buscador.getCodigo(),
                              EnvioRecepcionForm.this.tabla.getSelectedRow(),
                              EnvioRecepcionForm.this.tabla.getColumn("Código").getModelIndex()
                           );
                        EnvioRecepcionForm.this.tabla
                           .setValueAt(
                              buscador.getNombre(),
                              EnvioRecepcionForm.this.tabla.getSelectedRow(),
                              EnvioRecepcionForm.this.tabla.getColumn("Descripción").getModelIndex()
                           );
                        EnvioRecepcionForm.this.tabla
                           .setValueAt(
                              buscador.getSigla(),
                              EnvioRecepcionForm.this.tabla.getSelectedRow(),
                              EnvioRecepcionForm.this.tabla.getColumn("UM").getModelIndex()
                           );
                        EnvioRecepcionForm.this.tabla
                           .setValueAt(
                              buscador.getCosto_producto(),
                              EnvioRecepcionForm.this.tabla.getSelectedRow(),
                              EnvioRecepcionForm.this.tabla.getColumn("Costo").getModelIndex()
                           );
                        EnvioRecepcionForm.this.tabla
                           .setValueAt(
                              buscador.getV_tipoFiscal(),
                              EnvioRecepcionForm.this.tabla.getSelectedRow(),
                              EnvioRecepcionForm.this.tabla.getColumn("Tipo Fiscal").getModelIndex()
                           );
                        EnvioRecepcionForm.this.tabla
                           .setValueAt(
                              buscador.getV_iva(),
                              EnvioRecepcionForm.this.tabla.getSelectedRow(),
                              EnvioRecepcionForm.this.tabla.getColumn("IVA").getModelIndex()
                           );
                        EnvioRecepcionForm.this.tabla
                           .setValueAt(
                              buscador.getV_porcentaje_gravado(),
                              EnvioRecepcionForm.this.tabla.getSelectedRow(),
                              EnvioRecepcionForm.this.tabla.getColumn("PorcGravado").getModelIndex()
                           );
                     }
                  }
               }
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            EnvioRecepcionForm frame = new EnvioRecepcionForm();
