...
public class CondicionVentaUsuarioForm extends JDialogPrincipal implements ActionListener {
   List<Integer> codigosAEliminar = new ArrayList<>();
   private TablaCondicionVentaUsuario tabla;
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            CondicionVentaUsuarioForm frame = new CondicionVentaUsuarioForm("");
   ...
   public CondicionVentaUsuarioForm(String nombre_usuario) {
      this.nombre_usuario = nombre_usuario;
      this.setTitle("Condiciones de Ventas Habilitados");
      ...
      this.tabla = new TablaCondicionVentaUsuario(this.codigosAEliminar);
      ...
      if (nombre_usuario != null) {
         CondicionVentaUsuarioE.cargarCondicionVentaUsuario(nombre_usuario, this.tabla, this);
      } else {
   ...
   private void guardar() {
      int insertar = CondicionVentaUsuarioE.insertarCondicionVentaUsuarios(this.nombre_usuario, this.tabla, this, this.codigosAEliminar);
      if (insertar != 0) {
         DialogResultadoOperacion rs = new DialogResultadoOperacion("Condicion de Venta insertado correctamente", "correcto");
