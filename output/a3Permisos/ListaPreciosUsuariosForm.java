...
public class ListaPreciosUsuariosForm extends JDialogPrincipal implements ActionListener {
   List<Integer> codigosAEliminar = new ArrayList<>();
   private TablaListaPreciosUsuario tabla;
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            ListaPreciosUsuariosForm frame = new ListaPreciosUsuariosForm("");
   ...
   public ListaPreciosUsuariosForm(String nombre_usuario) {
      this.nombre_usuario = nombre_usuario;
      this.setTitle("Lista de Precios Habilitados");
      ...
      this.tabla = new TablaListaPreciosUsuario(this.codigosAEliminar);
      ...
      if (nombre_usuario != null) {
         ListaPreciosUsuariosE.cargarListaPrecioUsuario(nombre_usuario, this.tabla, this);
      } else {
   ...
   private void guardar() {
      int insertar = ListaPreciosUsuariosE.insertarListaPrecioUsuarios(this.nombre_usuario, this.tabla, this, this.codigosAEliminar);
      if (insertar != 0) {
         DialogResultadoOperacion rs = new DialogResultadoOperacion("Cuenta insertado correctamente", "correcto");
