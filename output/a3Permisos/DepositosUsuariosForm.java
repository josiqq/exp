...
public class DepositosUsuariosForm extends JDialogPrincipal implements ActionListener {
   List<Integer> codigosAEliminar = new ArrayList<>();
   private TablaDepositosUsuario tabla;
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            DepositosUsuariosForm frame = new DepositosUsuariosForm("");
   ...
   public DepositosUsuariosForm(String nombre_usuario) {
      this.nombre_usuario = nombre_usuario;
      this.setTitle("Depositos Habilitados");
      ...
      this.tabla = new TablaDepositosUsuario(this.codigosAEliminar);
      ...
      if (nombre_usuario != null) {
         DepositosUsuariosE.cargarDepositoUsuario(nombre_usuario, this.tabla, this);
      } else {
   ...
   private void guardar() {
      int insertar = DepositosUsuariosE.insertarDepositosUsuarios(this.nombre_usuario, this.tabla, this, this.codigosAEliminar);
      if (insertar != 0) {
