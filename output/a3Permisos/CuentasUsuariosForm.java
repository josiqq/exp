...
public class CuentasUsuariosForm extends JDialogPrincipal implements ActionListener {
   List<Integer> codigosAEliminar = new ArrayList<>();
   private TablasUsuariosPermisos tabla;
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            CuentasUsuariosForm frame = new CuentasUsuariosForm("");
   ...
   public CuentasUsuariosForm(String nombre_usuario) {
      this.nombre_usuario = nombre_usuario;
      this.setTitle("Cuentas Habilitadas");
      ...
      this.tabla = new TablasUsuariosPermisos(this.codigosAEliminar);
      ...
      if (nombre_usuario != null) {
         CuentasUsuariosE.cargarCuentaUsuario(nombre_usuario, this.tabla, this);
      } else {
   ...
   private void guardar() {
      int insertar = CuentasUsuariosE.insertarCuentasUsuarios(this.nombre_usuario, this.tabla, this, this.codigosAEliminar);
      if (insertar != 0) {
