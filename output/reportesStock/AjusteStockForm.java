...
public class AjusteStockForm extends JInternalPadreReporteJasper {
   private PanelPadre panelPaginas;
   private static final long serialVersionUID = 1L;
   private JDateChooser txt_fecha_ini;
   private LimiteTextFieldConSQLJasper txt_cod_motivo;
   ...
   public AjusteStockForm() {
      this.setTitle("Reporte de Listado de Ajuste de Stock");
      ...
      this.txt_cod_motivo = new LimiteTextFieldConSQLJasper(999999, this.lblNombreMotivo, "MotivosAjuste", this);
   ...
   public void exportarExcel() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final AjusteStockForm.DialogoProgreso dialogo = new AjusteStockForm.DialogoProgreso(null, "Exportando a Excel...");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JRXlsxExporter exporter = new JRXlsxExporter();
                     exporter.setExporterInput(new SimpleExporterInput(AjusteStockForm.this.jasperPrint));
                     ...
                     rs.setLocationRelativeTo(AjusteStockForm.this);
                     rs.setVisible(true);
   ...
   public void exportarPDF() {
      if (this.jasperPrint == null) {
         ...
         while (true) {
            ...
            final AjusteStockForm.DialogoProgreso dialogo = new AjusteStockForm.DialogoProgreso(null, "Exportando a PDF");
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
               protected Void doInBackground() {
                  try {
                     JasperExportManager.exportReportToPdfFile(AjusteStockForm.this.jasperPrint, archivoDestino.getAbsolutePath());
                  } catch (Exception var3) {
   ...
   public void imprimirPDF() {
      ...
      if (this.jasperPrint == null) {
         ...
         final AjusteStockForm.DialogoProgreso dialogo = new AjusteStockForm.DialogoProgreso(null, "Imprimiendo Reporte...");
         SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            protected Void doInBackground() {
               try {
   ...
   public void recuperar() {
      final AjusteStockForm.DialogoProgreso dialogo = new AjusteStockForm.DialogoProgreso(null, "Generando Reporte...");
      SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
         protected Void doInBackground() {
            try {
               SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
               String fecha_ini = dateFormat.format(AjusteStockForm.this.txt_fecha_ini.getDate());
               String fecha_fin = dateFormat.format(AjusteStockForm.this.txt_fecha_final.getDate());
               Map<String, Object> parametros = new HashMap<>();
               parametros.put("par_nro_registro", 0);
               parametros.put("par_cod_motivo", Integer.parseInt(AjusteStockForm.this.txt_cod_motivo.getText().trim().replace(".", "")));
               parametros.put("par_cod_deposito", Integer.parseInt(AjusteStockForm.this.txt_cod_deposito.getText().trim().replace(".", "")));
               parametros.put("par_fecha_ini", fecha_ini);
               parametros.put("par_fecha_fin", fecha_fin);
               AjusteStockForm.this.generarReporte(AjusteStockForm.this.panelPaginas, "reportes/AjusteStock.jasper", "", parametros, "ajuste_stock");
