...
public class ProductosListadoForm extends JinternalPadreReporte {
   ...
   public void recuperar() {
      ProductosE.buscarProductosTablaReporte(
   ...
   public ProductosListadoForm() {
      this.setTitle("Reporte de Listado de Productos");
      ...
      String[] cabecera = new String[]{"Codigo", "Nombre", "Tipo Fiscal", "IVA", "Marca", "Unidad Medida", "Proveedor"};
      ModeloTablaDefecto modeloTabla = new ModeloTablaDefecto(cabecera);
      this.tabla = new BuscadorTablaReportes(modeloTabla, "Productos", this);
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            ProductosListadoForm frame = new ProductosListadoForm();
